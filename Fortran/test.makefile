FC = ifort
FCFLAGS = -m64 -traceback -O3 -qopenmp -implicitnone -xSSE4.2 -axAVX   -lumfpack -lamd -lcholmod -lcolamd -lsuitesparseconfig -L${LAPACK_LIB} -lblas 
LDFLAFS = -m64 -traceback -O3 -qopenmp -implicitnone -xSSE4.2 -axAVX   -lumfpack -lamd -lcholmod -lcolamd -lsuitesparseconfig -L${LAPACK_LIB} -lblas 
